 <!-- Modal edit -->
 <form id="formUpdateEmpresario">
     <div class="modal fade" id="updateEmpresario" tabindex="-1" role="dialog" aria-labelledby aria-hidden="true">
         ...
         <div class="modal-dialog modal-lg" role="document">
             <div class="modal-content">
                 ...
                 <div class="modal-footer">
                     ...
                     <button type="submit" class="btn btn-success btn-sm" id="updateBtnEmpresario">Save changes</button>
                 </div>
             </div>
         </div>
     </div>
